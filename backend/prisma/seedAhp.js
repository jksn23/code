...
const DATA_STATIS = [
  {
    ...
    kriteria: [
      { nama: 'Lokasi & Aksesibilitas', tipe: 'benefit', bobot: 0.30 },
      { nama: 'Legalitas',              tipe: 'benefit', bobot: 0.25 },
      { nama: 'Kondisi Fisik',          tipe: 'benefit', bobot: 0.15 },
      { nama: 'Fasilitas Sekitar',      tipe: 'benefit', bobot: 0.10 },
      { nama: 'Lingkungan & Risiko',    tipe: 'benefit', bobot: 0.10 },
      { nama: 'Potensi Pengembangan',   tipe: 'benefit', bobot: 0.10 },
    ],
  },
  {
    namaKategori: 'Kendaraan',
    kriteria: [
      { nama: 'Kondisi Mesin',    tipe: 'benefit', bobot: 0.30 },
      { nama: 'Kilometer',        tipe: 'cost',    bobot: 0.20 },
      { nama: 'Tahun Produksi',   tipe: 'benefit', bobot: 0.15 },
      { nama: 'Riwayat Kendaraan',tipe: 'benefit', bobot: 0.12 },
      { nama: 'Merek/Model',      tipe: 'benefit', bobot: 0.12 },
      { nama: 'Kondisi Fisik',    tipe: 'benefit', bobot: 0.11 },
    ],
  },
  {
